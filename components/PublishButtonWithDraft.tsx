// components/PublishButtonWithDraft.tsx - Przycisk publikacji z zapisaniem draft
...
export default function PublishButtonWithDraft({ offerData, onDraftSaved }: PublishButtonWithDraftProps) {
  ...
  return (
    <div>
      ...
      <div ref={containerRef} style={{ display: draftSaved ? 'block' : 'none' }} />
    </div>
  )
}
