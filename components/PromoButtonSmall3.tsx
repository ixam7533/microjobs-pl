// components/PromoButtonSmall3.tsx - Mały przycisk promocji (301-1000zł) za 15zł
...
interface PromoButtonSmall3Props {
  offerId?: number | string
  offerTitle?: string
  onPromotionStart?: () => void
}

export default function PromoButtonSmall3({ offerId, offerTitle = '', onPromotionStart }: PromoButtonSmall3Props) {
      ...
      function ShopifyBuyInit() {
        ...
        window.ShopifyBuy.UI.onReady(client).then((ui: any) => {
          ui.createComponent('product', {
            id: '9710757380438', // ID produktu promocji za 15zł
